...
export default function Main() {
	return (
		<main className="flex flex-col mx-auto max-w-6xl justify-center px-4 bg-white dark:bg-gray-800 prose prose-lg md:prose-xl dark:prose-dark relative font-sans">
