        ...
        <div className="col-span-3">
          ...
          <p className="mt-8 text-center text-gray-500 dark:text-gray-400">
            <span className="relative inline-block">
              ...
              <span
                className={`pointer-events-none absolute top-full left-1/2 mt-2 -translate-x-1/2 transition-all duration-fast ${copied || hovered ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}
              >
